...
const Footer = () => {
  <div>
    <footer className="w-full bg-gray-400 p-4 text-center">
      ...
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0 m-10">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          ...
          <div className="md:w-[316px]">
            ...
            <p className="mt-[18px] text-[15px] font-normal text-blue-900">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>

            <div className="mt-[18px] flex gap-4 text-blue-900">
              <a
          ...
          <div className="md:w-[316px]">
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a
                  href="tel:+233-54865151"
                  className="font-Inter text-[14px] font-medium text-blue-900"
                >
                  +233(0)-000-000-000
                </a>
            ...
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a
                  href="mailto:postpone@email.com"
                  className="font-Inter text-[14px] font-medium text-blue-900"
                >
            ...
            <div className="mt-[18px] flex flex-wrap gap-x-[60px] gap-y-[18px]">
              <ul>
                <li>
                  <a
                    href="#"
                    className="text-[14px] font-normal text-blue-900/[80%]"
                  >
                    Privacy Policy
                  </a>
                </li>
      ...
      <div className="mt-[19px] pb-[32px] text-center">
        <p className="text-[14px] font-normal text-blue-900">
